    ...
    <div className="glass-card p-5 sm:p-6 animate-fade-up">
      <div className="flex items-start justify-between gap-4">
        <div className="flex items-center gap-4 min-w-0">
          <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-xl bg-ledger/10 border border-ledger/20 flex items-center justify-center shrink-0">
        ...
        <button
          ...
          className="shrink-0 p-2 rounded-lg border border-white/10 hover:border-white/20 hover:bg-white/5 transition-all text-ink-200 hover:text-white"
      ...
      <div className="mt-4 pt-4 border-t border-white/5 grid grid-cols-2 sm:grid-cols-4 gap-4">
        {[
          ...
          { label: "SIC Code", value: sic ? `${sic} · ${sicDesc || ""}` : "—" },
          {
            ...
            value: fiscalYearEnd ? formatFiscalYear(fiscalYearEnd) : "—",
          },
          {
            label: "Total Filings",
          ...
          <div key={label}>
            ...
            <p
              className="font-mono text-xs text-white mt-0.5 truncate"
              title={String(value)}
            >
              {value || "—"}
            </p>
